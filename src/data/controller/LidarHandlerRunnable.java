...
public class LidarHandlerRunnable implements Runnable {
    ...
    /**
     * Queue for the thread that does the data treatments.
     */
    ...
    /**
     * Puts a message in the queue for the thread that does the corresponding data processing.
    ...
    /**
     * Clears the queue for the thread that does the corresponding data processing.
     */
